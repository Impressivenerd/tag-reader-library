...
public class MP3Header
{
    ...
    private void getID3v1(FileStream fs)
    {
        ...
        if ((char)bytHeaderTAG[0] == 'T' && (char)bytHeaderTAG[1] == 'A' && (char)bytHeaderTAG[2] == 'G')
        {
            ...
            //Track
            if (bytHeaderTAG[126] != 0x00)
            {
                tag.Track = (int)bytHeaderTAG[126];
            }

            //Genre
            tag.Genre = (int)bytHeaderTAG[127];
            ...
            Console.WriteLine("Genre: " + tag.Genre.ToString());
    ...
    private void getID3v2(FileStream fs)
    {
        ...
        {
            id3v2 = true;
            //Console.WriteLine("ID3v2.{0:D}.{1:D} Exists", (int)bytHeaderID3[3], (int)bytHeaderID3[4]);
        }
    }
